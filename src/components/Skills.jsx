    ...
    return (
        <div name='skills' className="w-full h-screen bg-gradient-to-r from-cyan-400 to-teal-100 text-slate-900">
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full ">
                ...
                <p className="py-4 text-2xl text-center text-slate-800">I am always looking to improve myself and learn new things. Here is a list of technologies I have used so far on my development journey:</p>
