...
const Mywork = () => {
    return (
        <div name='mywork' className="w-full md:h-screen text-slate-800 bg-gradient-to-r from-cyan-400 to-teal-100 ">
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
                <div className="pb-8 w-full flex justify-center items-center flex-col">
                    <p className="text-4xl font-bold inline border-b-4 text-slate-900 border-cyan-500">My Work</p>
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    className="shadow-lg shadow-violet-100 group container rounded-md flex justify-center items-center mx-auto content-div">
                    ...
                    <div className="shadow-lg shadow-violet-100  group container rounded-md flex justify-center items-center mx-auto content-div">
                        <div className="opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col ">
                            <span className="text-lg font-bold text-white tracking-wider ">
                                Coming Soon
                            </span>
